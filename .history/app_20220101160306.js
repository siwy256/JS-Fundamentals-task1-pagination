...
const paginateArray = (dataEntries, settings) => {
	...
	if( ! Number.isInteger(actualPageIdx) ) { throw new Error(`parameter "actualPageIdx" in "setings" has to be integer.`); }
	if( ! Number.isInteger(entriesOnPage ) ) {throw new Error('parameter "entriesOnPage" in "setings" has to be integer.');	}
